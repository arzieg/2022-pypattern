...
def build_asos_request_url(station, start_date=None, end_date=None):
    ...
    start_date: datetime.datetime
        Starting time of data to be obtained - default to 24h ago
    ...
    url_str = ('https://mesonet.agron.iastate.edu/request/asos/1min_dl.php?station%5B%5D='+
               station +
               '&tz=UTC&year1='+
...
def wind_components(speed, direction):
    """
    Calculate the u,v wind vector components
    :param speed:
    :param direction:
    :return:
    """
